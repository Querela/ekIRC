 ...
 * @author ekDev
 */
public class ActionMessageToUserEvent extends IRCMessageEvent
{
    ...
    public ActionMessageToUserEvent(IRCNetwork ircNetwork, IRCUser sourceIRCUser, IRCUser targetIRCUser, String message)
    {
        super(ircNetwork);
    ...
    {
        return ActionMessageToUserEvent.listeners;
    }
