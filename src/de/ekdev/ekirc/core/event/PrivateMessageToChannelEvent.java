/**
 * PrivateMessageToChannelEvent.java
 */
 ...
 * @author ekDev
 */
public class PrivateMessageToChannelEvent extends IRCMessageEvent
{
    ...
    public PrivateMessageToChannelEvent(IRCNetwork ircNetwork, IRCUser sourceIRCUser, IRCChannel targetIRCChannel,
            String message)
    {
        super(ircNetwork);
    ...
    {
        return PrivateMessageToChannelEvent.listeners;
    }
